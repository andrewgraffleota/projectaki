...
class LiveTimetableChatbot {
                ...
                <div class="chat-header">
                    <div class="chat-header-content">
                        ...
                        <div>
                            ...
                            <p><span class="status-indicator"></span>Connected to <span id="modelStatus">Gemma3 (local)</span></p>
    ...
    updateModelStatus() {
        ...
        if (modelStatus) {
            let displayName = 'Gemma3 (local)';
            if (this.selectedModel === 'llama3.2:latest') {
                displayName = 'Illama 3.2 (local)';
            } else if (this.selectedModel === 'gemma3:1b') {
                displayName = 'Gemma3 1B (local)';
